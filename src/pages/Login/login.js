...
function Login() {
    const customerPaperStyle = { padding: 20, height: '70vh', width: 400, margin: '40px auto', backgroundColor: '#607d8b' }
                    ...
                    <Paper elevation={10} style={customerPaperStyle}>
                        ...
                        <Box sx={{ '& > :not(style)': { m: 1 } }}>
                            <form onSubmit={(e) => on_login(e)}>
                                ...
                                <br />
                                <Button variant="contained" type="submit" value="Submit" fullWidth>Login</Button>
